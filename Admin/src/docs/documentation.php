                    ...
                    <div class="card-body">
                      ...
                      <details class="mt-4" open>
                        ...
                        <ul class="list-py-1 list-unstyled ps-4">
                          ...
                          <li><i class="fa fa-php5 me-1"></i> <span>index.php</span></li>
                      </details>
                      </li>
                      </ul>
                      <ul class="list-py-1 list-unstyled ps-4">
                        <li>
                          <i class="fa fa-folder-open-o text-body me-1"></i>
                          <strong>docs</strong> - <span class="text-body">contains the php,css & js files for the documentation</span>
                        </li>
                        <li>
                          <i class="fa fa-folder-open-o text-body me-1"></i>
                      ...
                      <ul class="list-py-1 list-unstyled ps-4">
                        <details open>
                          ...
                          <li><i class="fa fa-php5 me-1"></i> index.php</li>
                          <details open>
                            <summary>
                              <i class="fa fa-folder-open-o text-body me-1"></i>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>horizontal-menu (However, horizontal-menu has different php structure. Refer pages/layout/horizontal-menu.php)</td>
                            </tr>
                            <tr>
                              <td>Horizontal menu 2</td>
                              <td>horizontal-menu-2 (However, horizontal-menu-2 has different php structure. Refer pages/layout/horizontal-menu-2.php)</td>
                            </tr>
                            <tr>
                              <td>Boxed layout</td>
                              <td>boxed-layout</td>
                ...
                <div class="col-12 grid-margin" id="customization">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p>The command <code>gulp build</code> is used to generate the dist folder. Any changes made to the src should be followed by a build command. Suppose you change or create php, Sass or JS files, you have to run the command to ensure that the changes are reflected in the dist folder.</p>
                      <hr class="hr" id="sass">
                      ...
                      <p class="mt-2">
                        <strong>Step 2: </strong>Make changes to these php files and inject them into all pages using <code>gulp inject</code>.
                      </p>
                      <p class="mt-2">
                      ...
                      <p>
                        <strong class="text-success">1.buildOptionalVendorScripts.</strong>(for js files) <textarea
                        class="multiple-codes">var ascript72 = gulp.src(['../node_modules/jstree/dist/jstree.min.js'])
        ...
        },
        {
          type: "control"
                        ...
                        <div data-pws-tab="SortableTable" data-pws-tab-name="Sortable table">
                          <p>
                            <a href="http://tablesorter.com/docs/">Tablesorter</a> is a jQuery plugin for turning a standard php table with THEAD and TBODY tags into a sortable table without page refreshes.
                          </p>
                          <h5 class="mt-5 mb-4">Usage</h5>
      ...
      Morris.Line({
        ...
        labels: ['Series A', 'Series B']
                        ...
                        <div data-pws-tab="sparkline" data-pws-tab-name="Sparkline">
                          <p>
                            <a href="https://omnipotent.net/jquery.sparkline/#s-about">Jquery Sparkline</a> generates sparklines (small inline charts) directly in the browser using data supplied either inline in the php, or via Javascript.
                          </p>
                          <h5 class="mt-5 mb-4">Usage</h5>
            ...
            label: "pounds"
                      ...
                      <div class="demo-tabs">
                        <div data-pws-tab="Vector-map" data-pws-tab-name="Vector Map">
                          <p>
                            <a href="http://jvectormap.com/">JvectorMap</a> uses only native browser technologies like JavaScript, CSS, php, SVG or VML.
                          </p>
                          <h5 class="mt-5 mb-4">Usage</h5>
      ...
      $('#example-fontawesome').barrating({
        ...
        showSelectedRating: false
                        ...
                        <div data-pws-tab="BTMaxLength" data-pws-tab-name="Bootstrap Max-Length">
                          <p>
                            <a href="http://mimo84.github.io/bootstrap-maxlength/">Bootstrap MaxLength</a> uses a Twitter Bootstrap label to show a visual feedback to the user about the maximum length of the field where the user is inserting text. Uses the php5 attribute "maxlength" to work.
                          </p>
                          <h5 class="mt-5 mb-4">Usage</h5>
                          <p> Add the following script files in &lt;body&gt;. </p>
                          <textarea class="multiple-codes">
