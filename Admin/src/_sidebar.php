<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="show_webinfo.php">
        <span class="menu-title">Website info</span>
        <i class="mdi mdi-home menu-icon"></i>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link"  href="show_about.php">
    ...
    <li class="nav-item">
      <a class="nav-link" href="show_ct.php">
    ...
    <li class="nav-item">
      <a class="nav-link"  href="show_brand.php">
    ...
    <li class="nav-item">
      <a class="nav-link" href="show_faq.php">
